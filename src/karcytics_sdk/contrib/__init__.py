"""Karcytics SDK Contrib — Optional utilities to support plugin development.
...
try:
    ...
    def _raise_import_error(*args, **kwargs):
        raise ImportError("This utility requires 'karcytics-core' or 'scikit-image' to be installed.")
