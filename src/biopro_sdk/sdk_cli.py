"""DEPRECATED: SDK CLI Utilities for BioPro developers.

This module is deprecated. Please use the modular `biopro_sdk.cli` package instead.
"""

import warnings

from biopro_sdk.cli.commands import diagnostics, migrate, scaffold, security
from biopro_sdk.cli.main import main

warnings.warn(
    "biopro_sdk.sdk_cli is deprecated and will be removed in a future release. Please use biopro_sdk.cli instead.",
    DeprecationWarning,
    stacklevel=2,
)
...
class SDKCLI:
    """Deprecated CLI handler for BioPro SDK operations."""
